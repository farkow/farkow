    ...
    <section id="entry" className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
      <div className="space-y-6">
        ...
        <p className="text-base text-slate-300 md:text-lg">
          ...
          Developer proficient in multiple languages. I build secure, scalable
          systems across both on-premise and cloud environments. Additionally, I
          specialize in setting up private, on-premise AI infrastructures to
          empower secure and independent innovation.
        </p>
      ...
      <Card className="shadow-glow border-slate-800 bg-slate-900/60">
        ...
        <div className="space-y-4 text-sm text-slate-300">
          ...
          <div className="rounded-lg border border-slate-800 bg-slate-950/40 p-4 text-xs tracking-[0.2em] text-slate-400 uppercase">
